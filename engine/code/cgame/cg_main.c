...
vmCvar_t	cg_drawCrosshairAlways;
...
vmCvar_t	cg_animateStatusBarHead;
vmCvar_t	cg_showObituary;
vmCvar_t	cg_showScoreboard;
#ifdef MISSIONPACK
...
vmCvar_t	cg_showWeaponName;
vmCvar_t	cg_showWeaponAlways;
...
static cvarTable_t cvarTable[] = {
	...
	{ &cg_animateStatusBarHead, "cg_animateStatusBarHead", "0", CVAR_ARCHIVE },
	{ &cg_showObituary, "cg_showObituary", "0", CVAR_ARCHIVE },
	{ &cg_showObituary, "cg_showScoreboard", "0", CVAR_ARCHIVE },
#ifdef MISSIONPACK
	...
	{ &cg_showWeaponName, "cg_showWeaponName", "0", CVAR_USERINFO | CVAR_ARCHIVE},
	{ &cg_showWeaponAlways, "cg_showWeaponAlways", "1", CVAR_USERINFO | CVAR_ARCHIVE},
...
static void CG_RegisterGraphics( void ) {
	...
	if ( cgs.gametype >= GT_TEAM || cg_buildScript.integer ) {
		...
		cgs.media.teamStatusBar = trap_R_RegisterShader( "white" );
#ifdef MISSIONPACK
