...
static void UI_NetworkOptionsMenu_Init( void ) {
	...
	networkOptionsInfo.banner.color				= color_blue;
	...
	networkOptionsInfo.graphics.color				= color_blue;
	...
	networkOptionsInfo.display.color				= color_blue;
	...
	networkOptionsInfo.sound.color					= color_blue;
	...
	networkOptionsInfo.network.color				= color_blue;
